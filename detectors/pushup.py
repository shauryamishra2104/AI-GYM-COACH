...
class PushUpDetector(BaseExercise):
    ...
    def process(self,landmarks) -> dict:
        ...
        key_landmarks_visible = landmarks[shoulder_idx].presence > self.MIN_VISIBILITY and landmarks[elbow_idx].presence > self.MIN_VISIBILITY and landmarks[wrist_idx].presence > self.MIN_VISIBILITY and landmarks[hip_idx].presence > self.MIN_VISIBILITY
