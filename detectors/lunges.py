...
class LungesDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        key_landmarks_visible = landmarks[front_hip_idx].presence > self.MIN_VISIBILITY and landmarks[front_knee_idx].presence > self.MIN_VISIBILITY and landmarks[front_ankle_idx].presence > self.MIN_VISIBILITY
