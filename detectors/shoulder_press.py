...
class ShoulderPressDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        left_vis = landmarks[self.LEFT_ELBOW].presence
        right_vis = landmarks[self.RIGHT_ELBOW].presence
        ...
        key_landmarks_visible = landmarks[shoulder_idx].presence > self.MIN_VISIBILITY and landmarks[elbow_idx].presence > self.MIN_VISIBILITY and landmarks[wrist_idx].presence > self.MIN_VISIBILITY
