...
class SquatDetector(BaseExercise):
    ...
    def process(self,landmarks):
        ...
        left_vis = landmarks[self.LEFT_KNEE].presence
        right_vis = landmarks[self.RIGHT_KNEE].presence
        ...
        key_landmark_visible = landmarks[hip_idx].presence >= self.MIN_VISIBILITY and landmarks[knee_idx].presence >= self.MIN_VISIBILITY and landmarks[ankle_idx].presence >= self.MIN_VISIBILITY
